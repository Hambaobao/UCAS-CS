...
//判断玩家1落子情况
	...
	{	
		for(int i=0;i<4;i++)
			printf("black_info[%d]null[%d]=%d  ",i,j,BlackScoreBoard[n][a-'A'+1].info[i].nullnum[j]);
		printf("\n");
		for(int i=4;i<8;i++)
			printf("black_info[%d]null[%d]=%d  ",i,j,BlackScoreBoard[n][a-'A'+1].info[i].nullnum[j]);
		printf("\n");
...
//判断玩家2落子情况
	...
	{	
		for(int i=0;i<4;i++)
			printf("white_info[%d]null[%d]=%d  ",i,j,WhiteScoreBoard[p][b-'A'+1].info[i].nullnum[j]);
		printf("\n");
		for(int i=4;i<8;i++)
			printf("white_info[%d]null[%d]=%d  ",i,j,WhiteScoreBoard[p][b-'A'+1].info[i].nullnum[j]);
		printf("\n");
