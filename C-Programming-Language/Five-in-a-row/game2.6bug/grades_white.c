...
long long int get_grades_white(int x,int y){											//获取最后分数
	long long int get_my_grades_white(int ,int);
	long long int get_opp_grades_white(int ,int);
...
long long int get_my_grades_white(int x,int y){
...
long long int get_opp_grades_white(int x,int y){
