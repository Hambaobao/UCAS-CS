...
//	for(int j=0;j<2;j++)
		{	
			for(int i=0;i<4;i++)
				printf("black_info[%d]link[0]=%d  ",i,BlackScoreBoard[n][a-'A'+1].info[i].linknum[0]);
			printf("\n");
		}

	for(int i=0;i<4;i++)
				printf("black_info[%d]opp[0]=%d  ",i,BlackScoreBoard[n][a-'A'+1].info[i].oppnum[0]);
			printf("\n");
...
//	for(int j=0;j<2;j++)
		{	
			for(int i=0;i<4;i++)
				printf("white_info[%d]link[0]=%d  ",i,WhiteScoreBoard[p][b-'A'+1].info[i].linknum[0]);
			printf("\n");
		}
	for(int i=0;i<4;i++)
		printf("white_info[%d]opp[0]=%d  ",i,WhiteScoreBoard[p][b-'A'+1].info[i].oppnum[0]);
	printf("\n");
