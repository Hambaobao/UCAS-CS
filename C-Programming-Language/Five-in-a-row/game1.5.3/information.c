...
/*	
	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=0;temp[m+1][n+1+i]==2;i++)	;	if(temp[m+1][n+1+i]==1)	WhiteScoreBoard[m][n].info[0].oppnum[0]++;		//记录——向对手棋子数
	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=1;temp[m+1][n+1-i]==2;i++)	;	if(temp[m+1][n+1-i]==1)	WhiteScoreBoard[m][n].info[0].oppnum[0]++;

	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=0;temp[m+1+i][n+1+i]==2;i++)	;	if(temp[m+1+i][n+1+i]==1)	WhiteScoreBoard[m][n].info[1].oppnum[0]++;		//记录/向对手棋子数
	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=1;temp[m+1-i][n+1-i]==2;i++)	;	if(temp[m+1-i][n+1-i]==1)	WhiteScoreBoard[m][n].info[1].oppnum[0]++;

	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=0;temp[m+1+i][n+1]==2;i++)	;	if(temp[m+1+i][n+1]==1)	WhiteScoreBoard[m][n].info[2].oppnum[0]++;		//记录 | 向对手棋子数
	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=1;temp[m+1-i][n+1]==2;i++)	;	if(temp[m+1-i][n+1]==1)	WhiteScoreBoard[m][n].info[2].oppnum[0]++;

	for(m=1;m<16;m++)	for(n=1;n<16;n++)	for(i=0;temp[m+1+i][n+1-i]==2;i++)	;	if(temp[m+1-i][n+1-i]==1)	WhiteScoreBoard[m][n].info[3].oppnum[0]++;		//记录\向对手棋子数
