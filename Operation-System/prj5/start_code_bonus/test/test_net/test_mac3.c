...
uint32_t buffer[256] = {0xffffffff, 0x5500ffff, 0xf77db57d, 0x00450008, 0x0000d400, 0x11ff0040, 0xa8c073d8, 0x00e00101, 0xe914fb00, 0x0004e914, 0x0000, 0x005e0001, 0x2300fb00, 0x84b7f28b, 0x00450008, 0x0000d400, 0x11ff0040, 0xa8c073d8, 0x00e00101, 0xe914fb00, 0x0801e914, 0x0000};
...
static void mac_send_desc_init(mac_t *mac)
{
    ...
    TX_Desc[PNUM-1].tdes0 = 0;
    TX_Desc[PNUM-1].tdes1 = RDES1_LS | RDES1_FS | RDES1_RER | RDES1_RCH | RDES1_RBS1;
    TX_Desc[PNUM-1].tdes2 = ((uint32_t)(&TX_Buffer[63]) & 0x1fffffff);
    TX_Desc[PNUM-1].tdes3 = ((uint32_t)(&TX_Desc[0]) & 0x1fffffff);
...
static void mac_recv_desc_init(mac_t *mac)
{
    ...
    for(i = 0; i < PNUM - 1; i++){
        RX_Desc[i].tdes0 = 0;
        RX_Desc[i].tdes1 = RDES1_IC | RDES1_RCH | RDES1_RBS1;
        RX_Desc[i].tdes2 = ((int)(&RX_Buffer[i]) & 0x1fffffff);
        RX_Desc[i].tdes3 = ((int)(&RX_Desc[i+1]) & 0x1fffffff);
    }

    RX_Desc[PNUM-1].tdes0 = 0;
    RX_Desc[PNUM-1].tdes1 = RDES1_RER | RDES1_RCH | RDES1_RBS1;
    RX_Desc[PNUM-1].tdes2 = ((uint32_t)(&RX_Buffer[63]) & 0x1fffffff);
    RX_Desc[PNUM-1].tdes3 = ((uint32_t)(&RX_Desc[0]) & 0x1fffffff);
