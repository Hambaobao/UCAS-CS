...
void pmem_queue_push(queue_t * queue, void *item)
{
    pageframe_t *_item = (pageframe_t *)item;
    /* queue is empty */
    if (queue->head == NULL)
    {
        queue->head = item;
    ...
    {
        ((pageframe_t *)(queue->tail))->next = item;
        _item->next = NULL;
        _item->prev = queue->tail;
        queue->tail = item;
    }    
...
void *pmem_queue_dequeue(queue_t *queue)
{
    pageframe_t *temp = (pageframe_t *)queue->head;
    ...
    {
        queue->head = ((pageframe_t *)(queue->head))->next;
        ((pageframe_t *)(queue->head))->prev = NULL;
    }
...
/* remove this item and return this item */
void *pmem_queue_remove(queue_t *queue, void *item)
{
    pageframe_t *_item = (pageframe_t *)item;
    pageframe_t *next = (pageframe_t *)_item->next;
    ...
    {
        queue->tail = _item->prev;
        ((pageframe_t *)(queue->tail))->next = NULL;
    }
    else
    {
        ((pageframe_t *)(_item->prev))->next = _item->next;
        ((pageframe_t *)(_item->next))->prev = _item->prev;
    }
